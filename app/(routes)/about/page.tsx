        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                I&apos;m Bibek Sabat, a Full Stack Developer with a passion for creating innovative web applications and exploring blockchain technologies. I&apos;m currently pursuing a Master&apos;s in Computer Science, where I continue to expand my knowledge and skills.
              </p>
              <p>
              ...
              <CardContent className="p-4">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Won the best project of the year.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Won the graphics desgining competition.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2 font-bold">•</span>
                    <span>
                      Won ₹10000 at Vikash Coding Competition 2022.
                    </span>
                  </li>
                </ul>
              </CardContent>
