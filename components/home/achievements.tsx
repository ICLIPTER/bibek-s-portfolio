...
import { Trophy, Medal, Award, Code, Gamepad, BookOpen } from "lucide-react";
...
const achievements: Achievement[] = [
 
  {
    ...
    title: "Winner of Call of Duty Tournament",
    colorClass: "text-blue-600 dark:text-blue-400",
  },
  {
    icon: <Award className="h-6 w-6" />,
    title: "Best Employee of the Year at JSW",
    colorClass: "text-green-600 dark:text-green-400",
  },
  {
    icon: <Trophy className="h-6 w-6" />,
    title: "Best employee of the Year Mentech",
    ...
    <section className="py-12 md:py-24 bg-muted/30 relative overflow-hidden">
      <div className="container px-4 md:px-6 mx-auto text-center">
        ...
        <div className="mt-10 inline-flex flex-wrap justify-center gap-2">
          ...
          <Badge variant="secondary" className="text-sm py-1.5 px-3">Best Employee</Badge>
